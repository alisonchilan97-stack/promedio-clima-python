...
|---------------|--------------------------|------------------|
| Estructura | Funciones | Clases y objetos |
| Organización | Lineal | Modular |
| Reutilización | Limitada | Alta |
| Escalabilidad | Baja | Alta |
| Mantenimiento | Difícil | Más sencillo |
...
# Autor
Nombre: Alison Chilan  
Asignatura: Programación  
Tema: Comparación de Programación Tradicional y POO en Python
